...
<template>
    <transition name="modal">
        <div class="wrapper md:w-1/5 sm:w-3/5 blur-none shadow-lg">
            <h1 class="md:text-2xl sm:text-md font-bold underline">History</h1>
            ...
            <button 
                type="button" 
                @click="$emit('close')"
                class="rounded-lg border-2 border-neutral-700 bg-neutral-200 hover:bg-neutral-400 text-primary-content text-sm p-1"
            >
                Close
            </button>
        </div>
